...
const faqData = [
  {
    ...
    answer: 'Yes, complimentary Wi-Fi is provided in all rooms and common areas. The connection is fast and reliable for work or entertainment.',
  },
  {
    id: '2',
  ...
  },
  {
    ...
    answer: 'Yes, extra beds are available upon request, subject to availability.',
  },
  {
    id: '4',
        ...
        {faqData.map((item, index) => (
          <View key={item.id} style={styles.accordion}>
            ...
            >
              ...
              <Ionicons
                name={index === activeIndex ? 'chevron-up-outline' : 'chevron-down-outline'}
                size={24}
                color="#000"
              />
            </TouchableOpacity>
